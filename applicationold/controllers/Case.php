...
class CaseController extends FControllerModel {
    const SITE_URL = 'http://192.168.1.200/';
    const SITE_NAME = "乐开音乐";

    public function init() {
        parent::init();
        $this->css['jplayer'] = 'http://192.168.1.200/jplayer/case/jplayer.css';
        $this->js = array(
            'http://192.168.1.200/js/jquery1.4.2.min.js',
            'http://192.168.1.200/js/jquery.easing.1.3.js',
            'http://192.168.1.200/js/allOneScroll.js',
            'http://192.168.1.200/jplayer/jquery.jplayer.min.js',
            'http://192.168.1.200/js/case.js',
        );
